...
export type HttpMethod = 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE' | 'HEAD' | 'OPTIONS' | Lowercase<'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE' | 'HEAD' | 'OPTIONS'>;
export type PathKey = string | number;
export type PathList = PathKey[];
export type PathInput = PathKey | PathList;
export type MaybePromise<T> = T | Promise<T>;
export type MaybeFactory<T> = T | (() => T);
export type ParamsValue = string | number | boolean | null | undefined | Date | ParamsValue[] | {
...
export type TransformResponse = (ctx: TransformResponseContext) => MaybePromise<any>;
...
export type BeforeRequest<TData = any> = (payload: any, ctx: RequestContext<TData>) => MaybePromise<any>;
export type AfterResponse<TData = any> = (body: any, ctx: RequestContext<TData> & {
    ok: boolean;
    status: number;
}) => MaybePromise<any>;
export type SuccessCallback<TData = any> = (body: any, model: ApixModel<TData>) => void;
export type ErrorCallback<TData = any> = (error: ApixError, model: ApixModel<TData>) => void;
export type FinishCallback<TData = any> = (model: ApixModel<TData>, error: ApixError | null) => void;
export type ProcessingCallback<TData = any> = (active: boolean, model: ApixModel<TData>) => void;
...
export type ResolvedModelOptions<TData = any> = Omit<ModelOptions<TData>, 'params' | 'headers' | 'default' | 'body'> & {
    params?: Params;
    headers?: HeadersInit;
    default?: MaybeFactory<TData>;
    body?: any;
